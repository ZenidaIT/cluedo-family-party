    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="flex gap-4 pt-6 border-t border-slate-100 mt-8 items-center">
                {handleCancel && (
                    <button onClick={handleCancel} className="flex-1 min-w-[120px] px-4 py-3 rounded-xl border border-slate-200 text-slate-500 hover:bg-slate-50 font-bold transition flex items-center justify-center gap-2">
                        <Ban size={18}/> Annulla
                    </button>
                )}
                ...
                {!isNew && handleDelete && (
                    <button onClick={handleDelete} className="flex-1 min-w-[120px] px-4 py-3 rounded-xl border border-red-100 text-red-500 bg-red-50 hover:bg-red-100 font-bold transition flex items-center justify-center gap-2">
                ...
                {!isNew && handleClone && (
                    <button onClick={handleClone} className="flex-1 min-w-[120px] px-4 py-3 rounded-xl border border-emerald-100 text-emerald-600 bg-emerald-50 hover:bg-emerald-100 font-bold transition flex items-center justify-center gap-2">
                        <Copy size={18}/> Duplica
                    </button>
                )}

                <button onClick={handleSave} className="flex-1 min-w-[120px] bg-indigo-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-indigo-700 transition shadow-lg shadow-indigo-200 flex items-center justify-center gap-2">
                    <Save size={20}/> Salva
                </button>
            </div>
        </div>
