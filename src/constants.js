...
export const PLAYER_COLORS = [
  ...
  { label: 'Giallo', class: 'bg-yellow-400 text-black border-2 border-white ring-1 ring-slate-200', hex: '#facc15' },
  { label: 'Lime', class: 'bg-lime-400 text-black border-2 border-white ring-1 ring-slate-200', hex: '#a3e635' },
  // Verdi / Blu / Ciano
  ...
  { label: 'Smeraldo', class: 'bg-emerald-500 text-white border-2 border-white ring-1 ring-slate-200', hex: '#10b981' },
  ...
  { label: 'Celeste', class: 'bg-sky-500 text-white border-2 border-white ring-1 ring-slate-200', hex: '#0ea5e9' },
  { label: 'Blu', class: 'bg-blue-500 text-white border-2 border-white ring-1 ring-slate-200', hex: '#3b82f6' },
  { label: 'Blu Scuro', class: 'bg-blue-700 text-white border-2 border-white ring-1 ring-slate-200', hex: '#1d4ed8' },
  ...
  { label: 'Grigio Scuro', class: 'bg-gray-700 text-white border-2 border-white ring-1 ring-slate-200', hex: '#374151' },
  ...
  { label: 'Viola Scuro', class: 'bg-purple-900 text-white border-2 border-white ring-1 ring-slate-200', hex: '#581c87' },
